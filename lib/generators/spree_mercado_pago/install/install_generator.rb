module SpreeMercadoPago
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_javascripts
        append_file "app/assets/javascripts/store/all.js", "//= require store/spree_mercado_pago\n"
        append_file "app/assets/javascripts/admin/all.js", "//= require admin/spree_mercado_pago\n"
      end
